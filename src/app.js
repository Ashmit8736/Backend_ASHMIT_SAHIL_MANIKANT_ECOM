process.env.TZ = "Asia/Kolkata"; // ✅ YE ADD KARO
...
const publicSupplierProductRoute =
  require("./routes/public.supplier.product").default;
const publicBuyerProductRoute =
  require("./routes/public.buyer.product").default;
